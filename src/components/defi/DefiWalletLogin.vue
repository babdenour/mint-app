<template>
  <div class="vue3rdj5__mode" v-if="openContent">
    <div class="vue3rdj5__mode-error" v-if="error">{{ error }}</div>
    <div v-else class="vue3rdj5__infos">
      <p
        class="vue3rdj5__infos-txt"
      >Please unlock your Defi Extension and select the wallet you want to connect.</p>
      <p
        class="vue3rdj5__infos-txt"
      >If Nothing happen, you migth not have installed the Maiar Defi Wallet Extension.</p>
      <p class="vue3rdj5__infos-txt">
        You can download it
        <a
          class="vue3rdj5__infos-link"
